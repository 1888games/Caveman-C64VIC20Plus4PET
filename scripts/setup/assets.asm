...
INS_TILES:
	.if(target == "C64" || target == "264") {
		.import binary "../assets/title/x64/ins_tiles.bin"
	}

	.if(target == "VIC") {
		.import binary "../assets/title/vic/ins_tiles.bin"
	}
...
INS_MAP:
	...
	.if(target == "C64" || target == "264") {
		.import binary "../assets/title/x64/ins_map.bin"
	}

	.if(target == "VIC") {
		.import binary "../assets/title/vic/ins_map.bin"
	}
